...
import { sampleWithRequiredData } from '../submission-assignment.test-samples';
...
describe('SubmissionAssignment Management Component', () => {
  let comp: SubmissionAssignmentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [SubmissionAssignmentComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(SubmissionAssignmentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.submissionAssignments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
