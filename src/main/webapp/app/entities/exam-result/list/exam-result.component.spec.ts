...
import { sampleWithRequiredData } from '../exam-result.test-samples';
...
describe('ExamResult Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.examResults?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to examResultService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExamResultIdentifier');
      const id = comp.trackId(entity);
      expect(service.getExamResultIdentifier).toHaveBeenCalledWith(entity);
