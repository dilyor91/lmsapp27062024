...
import { sampleWithNewData, sampleWithRequiredData } from '../quiz-result.test-samples';
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            totalQuestionCnt: expect.any(Object),
            correctAnswerCnt: expect.any(Object),
            wrongAnswerCnt: expect.any(Object),
