...
describe('Grade Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call submissionAssignment query and add missing value', () => {
      ...
      const submissionAssignment: ISubmissionAssignment = { id: 26005 };
      grade.submissionAssignment = submissionAssignment;

      const submissionAssignmentCollection: ISubmissionAssignment[] = [{ id: 18282 }];
    ...
    it('Should call Teacher query and add missing value', () => {
      const grade: IGrade = { id: 456 };
      const teacher: ITeacher = { id: 23421 };
      grade.teacher = teacher;

      const teacherCollection: ITeacher[] = [{ id: 31646 }];
    ...
    it('Should call Assignment query and add missing value', () => {
      const grade: IGrade = { id: 456 };
      const assignment: IAssignment = { id: 18228 };
      grade.assignment = assignment;

      const assignmentCollection: IAssignment[] = [{ id: 14625 }];
    ...
    it('Should update editForm', () => {
      const grade: IGrade = { id: 456 };
      const submissionAssignment: ISubmissionAssignment = { id: 15538 };
      grade.submissionAssignment = submissionAssignment;
      const teacher: ITeacher = { id: 30600 };
      grade.teacher = teacher;
      const assignment: IAssignment = { id: 10579 };
      grade.assignment = assignment;
