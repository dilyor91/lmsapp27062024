...
describe('Notification Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Quiz query and add missing value', () => {
      ...
      const quiz: IQuiz = { id: 25306 };
      notification.quiz = quiz;

      const quizCollection: IQuiz[] = [{ id: 28149 }];
    ...
    it('Should call Assignment query and add missing value', () => {
      const notification: INotification = { id: 456 };
      const assignment: IAssignment = { id: 16410 };
      notification.assignment = assignment;

      const assignmentCollection: IAssignment[] = [{ id: 17053 }];
    ...
    it('Should call SubmissionAssignment query and add missing value', () => {
      const notification: INotification = { id: 456 };
      const submissionAssignment: ISubmissionAssignment = { id: 24241 };
      notification.submissionAssignment = submissionAssignment;

      const submissionAssignmentCollection: ISubmissionAssignment[] = [{ id: 28972 }];
    ...
    it('Should call Student query and add missing value', () => {
      const notification: INotification = { id: 456 };
      const student: IStudent = { id: 18451 };
      notification.student = student;

      const studentCollection: IStudent[] = [{ id: 14462 }];
    ...
    it('Should call Teacher query and add missing value', () => {
      const notification: INotification = { id: 456 };
      const teacher: ITeacher = { id: 25805 };
      notification.teacher = teacher;

      const teacherCollection: ITeacher[] = [{ id: 1194 }];
    ...
    it('Should update editForm', () => {
      const notification: INotification = { id: 456 };
      const quiz: IQuiz = { id: 1015 };
      notification.quiz = quiz;
      const assignment: IAssignment = { id: 20517 };
      notification.assignment = assignment;
      const submissionAssignment: ISubmissionAssignment = { id: 25374 };
      notification.submissionAssignment = submissionAssignment;
      const student: IStudent = { id: 31980 };
      notification.student = student;
      const teacher: ITeacher = { id: 13547 };
      notification.teacher = teacher;
