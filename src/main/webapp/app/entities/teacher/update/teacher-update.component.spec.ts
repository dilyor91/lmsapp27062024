...
describe('Teacher Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 23612 };
      teacher.user = user;

      const userCollection: IUser[] = [{ id: 2773 }];
    ...
    it('Should call Faculty query and add missing value', () => {
      const teacher: ITeacher = { id: 456 };
      const faculty: IFaculty = { id: 24059 };
      teacher.faculty = faculty;

      const facultyCollection: IFaculty[] = [{ id: 1286 }];
    ...
    it('Should call Department query and add missing value', () => {
      const teacher: ITeacher = { id: 456 };
      const department: IDepartment = { id: 25293 };
      teacher.department = department;

      const departmentCollection: IDepartment[] = [{ id: 5911 }];
    ...
    it('Should update editForm', () => {
      const teacher: ITeacher = { id: 456 };
      const user: IUser = { id: 30568 };
      teacher.user = user;
      const faculty: IFaculty = { id: 1832 };
      teacher.faculty = faculty;
      const department: IDepartment = { id: 16865 };
      teacher.department = department;
