...
describe('Teacher Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 17458 };
      teacher.user = user;

      const userCollection: IUser[] = [{ id: 10594 }];
    ...
    it('Should call Faculty query and add missing value', () => {
      const teacher: ITeacher = { id: 456 };
      const faculty: IFaculty = { id: 20969 };
      teacher.faculty = faculty;

      const facultyCollection: IFaculty[] = [{ id: 8065 }];
    ...
    it('Should call Department query and add missing value', () => {
      const teacher: ITeacher = { id: 456 };
      const department: IDepartment = { id: 22036 };
      teacher.department = department;

      const departmentCollection: IDepartment[] = [{ id: 6165 }];
    ...
    it('Should update editForm', () => {
      const teacher: ITeacher = { id: 456 };
      const user: IUser = { id: 32653 };
      teacher.user = user;
      const faculty: IFaculty = { id: 12446 };
      teacher.faculty = faculty;
      const department: IDepartment = { id: 22139 };
      teacher.department = department;
