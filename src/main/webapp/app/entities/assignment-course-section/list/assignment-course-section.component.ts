...
import { EntityArrayResponseType, AssignmentCourseSectionService } from '../service/assignment-course-section.service';
...
export class AssignmentCourseSectionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAssignmentCourseSection): number =>
    this.assignmentCourseSectionService.getAssignmentCourseSectionIdentifier(item);
