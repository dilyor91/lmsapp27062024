...
import { sampleWithRequiredData } from '../course-section.test-samples';
...
describe('CourseSection Management Component', () => {
  let comp: CourseSectionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CourseSectionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courseSections?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to courseSectionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCourseSectionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCourseSectionIdentifier).toHaveBeenCalledWith(entity);
