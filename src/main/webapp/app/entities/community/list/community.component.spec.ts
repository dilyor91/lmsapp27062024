...
import { sampleWithRequiredData } from '../community.test-samples';
...
describe('Community Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to communityService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCommunityIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCommunityIdentifier).toHaveBeenCalledWith(entity);
