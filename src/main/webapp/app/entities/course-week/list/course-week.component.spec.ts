...
import { sampleWithRequiredData } from '../course-week.test-samples';
import { CourseWeekService } from '../service/course-week.service';

import { CourseWeekComponent } from './course-week.component';
import SpyInstance = jest.SpyInstance;

describe('CourseWeek Management Component', () => {
  let comp: CourseWeekComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CourseWeekComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courseWeeks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to courseWeekService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCourseWeekIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCourseWeekIdentifier).toHaveBeenCalledWith(entity);
