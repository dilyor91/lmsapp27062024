...
describe('Attendance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Student query and add missing value', () => {
      ...
      const student: IStudent = { id: 511 };
      attendance.student = student;

      const studentCollection: IStudent[] = [{ id: 12960 }];
    ...
    it('Should call Lesson query and add missing value', () => {
      const attendance: IAttendance = { id: 456 };
      const lesson: ILesson = { id: 3654 };
      attendance.lesson = lesson;

      const lessonCollection: ILesson[] = [{ id: 21045 }];
    ...
    it('Should update editForm', () => {
      const attendance: IAttendance = { id: 456 };
      const student: IStudent = { id: 9374 };
      attendance.student = student;
      const lesson: ILesson = { id: 30958 };
      attendance.lesson = lesson;
