...
describe('Attendance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Student query and add missing value', () => {
      ...
      const student: IStudent = { id: 15136 };
      attendance.student = student;

      const studentCollection: IStudent[] = [{ id: 6612 }];
    ...
    it('Should call Lesson query and add missing value', () => {
      const attendance: IAttendance = { id: 456 };
      const lesson: ILesson = { id: 22016 };
      attendance.lesson = lesson;

      const lessonCollection: ILesson[] = [{ id: 29479 }];
    ...
    it('Should update editForm', () => {
      const attendance: IAttendance = { id: 456 };
      const student: IStudent = { id: 14118 };
      attendance.student = student;
      const lesson: ILesson = { id: 13714 };
      attendance.lesson = lesson;
