...
describe('Attendance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Student query and add missing value', () => {
      ...
      const student: IStudent = { id: 32344 };
      attendance.student = student;

      const studentCollection: IStudent[] = [{ id: 14024 }];
    ...
    it('Should call Lesson query and add missing value', () => {
      const attendance: IAttendance = { id: 456 };
      const lesson: ILesson = { id: 4563 };
      attendance.lesson = lesson;

      const lessonCollection: ILesson[] = [{ id: 22034 }];
    ...
    it('Should update editForm', () => {
      const attendance: IAttendance = { id: 456 };
      const student: IStudent = { id: 374 };
      attendance.student = student;
      const lesson: ILesson = { id: 27373 };
      attendance.lesson = lesson;
