...
describe('Attendance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Student query and add missing value', () => {
      ...
      const student: IStudent = { id: 31285 };
      attendance.student = student;

      const studentCollection: IStudent[] = [{ id: 4 }];
    ...
    it('Should call Lesson query and add missing value', () => {
      const attendance: IAttendance = { id: 456 };
      const lesson: ILesson = { id: 11866 };
      attendance.lesson = lesson;

      const lessonCollection: ILesson[] = [{ id: 5428 }];
    ...
    it('Should update editForm', () => {
      const attendance: IAttendance = { id: 456 };
      const student: IStudent = { id: 31644 };
      attendance.student = student;
      const lesson: ILesson = { id: 7246 };
      attendance.lesson = lesson;
