...
describe('QuizCourseSection Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Course query and add missing value', () => {
      ...
      const course: ICourse = { id: 24290 };
      quizCourseSection.course = course;

      const courseCollection: ICourse[] = [{ id: 28859 }];
    ...
    it('Should call CourseSection query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const courseSection: ICourseSection = { id: 24579 };
      quizCourseSection.courseSection = courseSection;

      const courseSectionCollection: ICourseSection[] = [{ id: 23601 }];
    ...
    it('Should call Quiz query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const quiz: IQuiz = { id: 29692 };
      quizCourseSection.quiz = quiz;

      const quizCollection: IQuiz[] = [{ id: 8601 }];
    ...
    it('Should update editForm', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const course: ICourse = { id: 5834 };
      quizCourseSection.course = course;
      const courseSection: ICourseSection = { id: 12933 };
      quizCourseSection.courseSection = courseSection;
      const quiz: IQuiz = { id: 25749 };
      quizCourseSection.quiz = quiz;
