...
describe('QuizCourseSection Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Course query and add missing value', () => {
      ...
      const course: ICourse = { id: 15816 };
      quizCourseSection.course = course;

      const courseCollection: ICourse[] = [{ id: 3746 }];
    ...
    it('Should call CourseSection query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const courseSection: ICourseSection = { id: 29446 };
      quizCourseSection.courseSection = courseSection;

      const courseSectionCollection: ICourseSection[] = [{ id: 7456 }];
    ...
    it('Should call Quiz query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const quiz: IQuiz = { id: 23082 };
      quizCourseSection.quiz = quiz;

      const quizCollection: IQuiz[] = [{ id: 2943 }];
    ...
    it('Should update editForm', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const course: ICourse = { id: 9447 };
      quizCourseSection.course = course;
      const courseSection: ICourseSection = { id: 26904 };
      quizCourseSection.courseSection = courseSection;
      const quiz: IQuiz = { id: 27094 };
      quizCourseSection.quiz = quiz;
