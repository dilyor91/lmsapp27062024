...
describe('QuizCourseSection Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Course query and add missing value', () => {
      ...
      const course: ICourse = { id: 20710 };
      quizCourseSection.course = course;

      const courseCollection: ICourse[] = [{ id: 12123 }];
    ...
    it('Should call CourseSection query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const courseSection: ICourseSection = { id: 5787 };
      quizCourseSection.courseSection = courseSection;

      const courseSectionCollection: ICourseSection[] = [{ id: 17161 }];
    ...
    it('Should call Quiz query and add missing value', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const quiz: IQuiz = { id: 8130 };
      quizCourseSection.quiz = quiz;

      const quizCollection: IQuiz[] = [{ id: 14130 }];
    ...
    it('Should update editForm', () => {
      const quizCourseSection: IQuizCourseSection = { id: 456 };
      const course: ICourse = { id: 10895 };
      quizCourseSection.course = course;
      const courseSection: ICourseSection = { id: 14442 };
      quizCourseSection.courseSection = courseSection;
      const quiz: IQuiz = { id: 31804 };
      quizCourseSection.quiz = quiz;
