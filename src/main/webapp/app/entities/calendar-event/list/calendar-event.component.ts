...
import { EntityArrayResponseType, CalendarEventService } from '../service/calendar-event.service';
...
export class CalendarEventComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.calendarEvents = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICalendarEvent[] | null): ICalendarEvent[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.calendarEventService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
