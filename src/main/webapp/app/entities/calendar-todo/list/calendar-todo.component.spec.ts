...
import { sampleWithRequiredData } from '../calendar-todo.test-samples';
...
describe('CalendarTodo Management Component', () => {
  let comp: CalendarTodoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CalendarTodoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.calendarTodos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
