...
import { sampleWithRequiredData } from '../lesson-material.test-samples';
...
describe('LessonMaterial Management Component', () => {
  let comp: LessonMaterialComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(LessonMaterialComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.lessonMaterials?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
