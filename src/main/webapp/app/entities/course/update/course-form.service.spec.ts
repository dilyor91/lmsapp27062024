      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            courseImagePath: expect.any(Object),
            courseStartDate: expect.any(Object),
            courseEndDate: expect.any(Object),
            courseFormat: expect.any(Object),
            published: expect.any(Object),
            selfEnrollment: expect.any(Object),
            selfEnrollmentCode: expect.any(Object),
            storageQuota: expect.any(Object),
