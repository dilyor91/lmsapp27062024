...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, uz.momoit.lms_canvas.domain.CalendarTodo.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.AnnouncementCourseSection.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.Building.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.Room.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.AnnouncementStudentRead.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.TimeTable.class.getName());
            ...
            createCache(cm, uz.momoit.lms_canvas.domain.CommunityMessage.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.Exam.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.ExamResult.class.getName());
            createCache(cm, uz.momoit.lms_canvas.domain.Activity.class.getName());
