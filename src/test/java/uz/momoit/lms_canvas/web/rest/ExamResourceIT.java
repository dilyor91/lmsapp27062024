...
class ExamResourceIT {
    ...
    private static final ExamTypeEnum DEFAULT_TYPE = ExamTypeEnum.INTERIM;
    private static final ExamTypeEnum UPDATED_TYPE = ExamTypeEnum.FINAL;

    private static final Float DEFAULT_MAX_POINT = 1F;
    private static final Float UPDATED_MAX_POINT = 2F;
    ...
    public static Exam createEntity() {
        return new Exam().type(DEFAULT_TYPE).maxPoint(DEFAULT_MAX_POINT);
    }
    ...
    public static Exam createUpdatedEntity() {
        return new Exam().type(UPDATED_TYPE).maxPoint(UPDATED_MAX_POINT);
    }
    ...
    void getAllExams() throws Exception {
        ...
        restExamMockMvc
            ...
            .andExpect(jsonPath("$.[*].maxPoint").value(hasItem(DEFAULT_MAX_POINT.doubleValue())));
    }
    ...
    void getExam() throws Exception {
        ...
        restExamMockMvc
            ...
            .andExpect(jsonPath("$.maxPoint").value(DEFAULT_MAX_POINT.doubleValue()));
    }
    ...
    void putExistingExam() throws Exception {
        ...
        updatedExam.type(UPDATED_TYPE).maxPoint(UPDATED_MAX_POINT);
    ...
    void fullUpdateExamWithPatch() throws Exception {
        ...
        partialUpdatedExam.type(UPDATED_TYPE).maxPoint(UPDATED_MAX_POINT);
