...
import uz.momoit.lms_canvas.repository.NotificationRepository;
import uz.momoit.lms_canvas.service.dto.NotificationDTO;
import uz.momoit.lms_canvas.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_NOTIFICATION_TYPE = NotificationType.ASSIGNMENT;
    private static final NotificationType UPDATED_NOTIFICATION_TYPE = NotificationType.QUIZ;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.readDate(UPDATED_READ_DATE).read(UPDATED_READ).notificationType(UPDATED_NOTIFICATION_TYPE);
